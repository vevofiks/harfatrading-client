      ...
      <div className="mb-12">
        ...
        {displayedProducts.length === 0 ? (
          <div className="text-center mt-10">
            <h3 className="text-xl font-semibold mb-2 text-gray-600">No new arrivals available</h3>
            <MotionLink
              href="/products"
              whileHover={{ scale: 1.05 }}
              className="inline-block mt-4 px-6 py-3 bg-red-600 text-white rounded-lg shadow hover:bg-red-700 transition"
            >
        ...
        {displayCount < products.length && displayedProducts.length > 0 && (
          <button
